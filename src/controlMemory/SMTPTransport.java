  ...
  extends Transport
{
  ...
  public SMTPTransport(Session paramSession, URLName paramURLName, String name, boolean isSSL)
  {
    ...
    throws MessagingException
  {
    ...
    Object localObject11 = "MAIL FROM:" + normalizeAddress(str);
    if (supportsExtension("DSN"))
    {
      localObject2 = null;
      if ((this.message instanceof SMTPMessage)) {
        localObject2 = ((SMTPMessage)this.message).getDescription();
      }
      if (localObject2 == null) {
        localObject2 = this.session.getProperty("mail." + this.name + ".dsn.ret");
      }
      if (localObject2 != null) {
        localObject11 = localObject11 + " RET=" + (String)localObject2;
      }
    }
    issueCommand((String)localObject11, 250);
  }
    ...
    throws MessagingException
  {
    ...
    {
      if ((this.message instanceof SMTPMessage)) {
        str2 = ((SMTPMessage)this.message).getDescription();
      }
      if (str2 == null) {
